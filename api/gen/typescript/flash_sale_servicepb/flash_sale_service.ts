...
export const protobufPackage = "flash_sale_servicepb";
...
/** Flash sale service */
export interface UflashUsaleUserviceService {
  /** Add your RPC methods here */
  HealthCheck(request: HealthCheckRequest): Promise<HealthCheckResponse>;
}

export const UflashUsaleUserviceServiceServiceName = "flash_sale_servicepb.UflashUsaleUserviceService";
export class UflashUsaleUserviceServiceClientImpl implements UflashUsaleUserviceService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || UflashUsaleUserviceServiceServiceName;
    this.rpc = rpc;
