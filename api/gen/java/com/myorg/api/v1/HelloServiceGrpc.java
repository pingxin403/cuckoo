...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.myorg.api.v1.HelloRequest,
      com.myorg.api.v1.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.myorg.api.v1.HelloRequest.class,
      responseType = com.myorg.api.v1.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.myorg.api.v1.HelloRequest,
      com.myorg.api.v1.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.myorg.api.v1.HelloRequest, com.myorg.api.v1.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.myorg.api.v1.HelloRequest, com.myorg.api.v1.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myorg.api.v1.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myorg.api.v1.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.myorg.api.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.myorg.api.v1.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
     ...
     * </pre>
     */
    public void sayHello(com.myorg.api.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.myorg.api.v1.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingV2Stub
     ...
     * </pre>
     */
    public com.myorg.api.v1.HelloResponse sayHello(com.myorg.api.v1.HelloRequest request) throws io.grpc.StatusException {
  ...
  public static final class HelloServiceBlockingStub
     ...
     * </pre>
     */
    public com.myorg.api.v1.HelloResponse sayHello(com.myorg.api.v1.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.myorg.api.v1.HelloResponse> sayHello(
        com.myorg.api.v1.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.myorg.api.v1.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.myorg.api.v1.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.myorg.api.v1.HelloRequest,
              com.myorg.api.v1.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.myorg.api.v1.HelloProto.getDescriptor();
    }
