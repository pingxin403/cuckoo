...
- [x] 3. Hello 服务实现（Java/Spring Boot）
  - 初始化 Java 项目
  - 实现 gRPC 服务
  - 配置和测试
  - _Requirements: 2.1, 2.2, 2.3, 2.4, 2.5, 7.1, 7.2, 7.4, 7.5_

- [x] 3.1 初始化 Hello 服务项目
...
- [x] 5.2 生成 TypeScript Protobuf 代码
  - 运行 `make gen-proto-ts`
  - 验证生成的代码在 `apps/web/src/gen/`
  - 配置 TypeScript 路径别名
  - _Requirements: 6.3, 6.7_

- [x] 5.3 配置 gRPC-Web 客户端
