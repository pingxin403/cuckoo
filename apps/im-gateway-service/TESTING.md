# Testing Guide for im-gateway-service

This document provides comprehensive testing guidelines for the im-gateway-service service.
...
cd apps/im-gateway-service && go test ./... -tags=property

# Coverage verification
cd apps/im-gateway-service && ./scripts/test-coverage.sh
```
