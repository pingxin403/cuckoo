 ...
 * Tests the service running in Docker with real gRPC communication
 * 
 * Note: This test expects the service to be already running (via docker-compose)
...
class HelloServiceIntegrationTest {
    ...
    private static final int GRPC_PORT = Integer.parseInt(System.getenv().getOrDefault("GRPC_PORT", "9090"));
